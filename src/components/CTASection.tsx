    ...
    <section id="contact" className="bg-primary text-primary-foreground">
      <div className="container py-20 md:py-28">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-primary-foreground/70 text-base md:text-lg leading-relaxed mb-10 max-w-lg mx-auto">If you have seen a snake on your property in Mudjimba, or on the Sunshine Coast, call immediately for professional removal.
