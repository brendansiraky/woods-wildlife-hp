...
const HeroSection = () => {
    return (
        <section className='pt-16 pb-8 md:pt-24 md:pb-16 lg:pt-32 lg:pb-24'>
            ...
            <div className='max-w-3xl'>
                ...
                <h1 className='text-[3.25rem] md:text-[4.75rem] lg:text-[6.375rem] font-extrabold leading-[0.9] mb-[34px]'>
                    Snake Catcher
                    <br />
                    Sunshine Coast
                </h1>
                ...
                <p className='text-[1.06rem] md:text-[1.175rem] max-w-xl mb-8 leading-relaxed' style={{ color: 'hsl(160, 12%, 33%)' }}>
                    Fully licensed snake catcher based in Mudjimba, with fast local response across the Sunshine Coast. Safe, professional snake removal available 24/7.
                </p>
                ...
                <p className='text-sm text-muted-foreground'>
                    $165 Daytime call out • Available 24/7 • Mudjimba
                </p>
            </div>
            </div>
        </section>
